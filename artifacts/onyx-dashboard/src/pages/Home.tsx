...
import { ChevronRight, Settings2, Activity, Fuel, Thermometer } from "lucide-react";
import { Link } from "wouter";
import a6Image from "@assets/audi-a6.png";
  ...
  return (
    ...
    >
      ...
      <div className="px-6 flex flex-col gap-4 pb-8">
        <button className="w-full glass-card hover:bg-white/5 active:bg-white/10 transition-colors py-4 rounded-2xl flex justify-center items-center gap-2 text-sm font-medium">
          <span>Подробнее</span>
